...
// interval). A config with no row yet yields a zero Profile — the caller substitutes
// defaults. Values are returned as stored; no default substitution happens here.
